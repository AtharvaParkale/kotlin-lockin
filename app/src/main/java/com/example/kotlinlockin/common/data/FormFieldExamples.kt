    ...
    Example(
        ...
        Column(
            ...
            options.forEach { option ->
                Row(verticalAlignment = Alignment.CenterVertically) {
                    RadioButton(
                        selected = selectedGender == option, onClick = { selectedGender = option })
                    Text(option)
                }
            }
            ...
            Button(
                onClick = { println("Form submitted!") }, enabled = acceptTerms
            ) {
                Text("Submit")
            }
        }
