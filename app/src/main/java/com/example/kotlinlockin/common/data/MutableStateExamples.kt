...
fun getMutableStateExamples(): List<Example> {
    return listOf(
        ...
        composableWidget = {
            ...
            Column {
                TextField(
                    value = stringState.value, onValueChange = { stringState.value = it })
